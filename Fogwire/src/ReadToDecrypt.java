...
public class ReadToDecrypt {
	String firstCopy = "unlocked.txt";
	File firstC;
	File theFile;
	String thefile = "locked.txt";
	DesEncryption de = new DesEncryption();
	DesDecryption dd = new DesDecryption();
	// ***********************************************************
	// *****--Constructor to Class . All Methods may run from here--*****

	public ReadToDecrypt() throws IOException {
	...
	private void writeToFile(String file) throws IOException {
		DataOutputStream out = new DataOutputStream(
				new BufferedOutputStream(new FileOutputStream("C:\\FogWire2\\Unlocked_Docs\\"+firstCopy)));
		DataInputStream in = new DataInputStream(
				new BufferedInputStream(new FileInputStream("C:\\FogWire2\\Locked_Docs\\"+theFile)));
